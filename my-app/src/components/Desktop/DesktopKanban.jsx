    ...
    return (
        <div className="hidden md:flex flex-row gap-4">
            <DragDropContext onDragEnd={handleDragEnd}>
                {statuses.map((status) => (
                    <div key={status} className="flex-1 bg-gray-100 p-4 rounded-lg shadow-md min-h-[300px]">
                        ...
                        <Droppable droppableId={status}>
                            {(provided) => (
                                <div
                                    ...
                                    className="h-[500px] overflow-y-auto scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-200"
                                >
                                    <AnimatePresence>
